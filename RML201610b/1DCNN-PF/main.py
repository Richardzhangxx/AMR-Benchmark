...
def predict(model):
    ...
    mltools.plot_confusion_matrix(confnorm, labels=['8PSK','AM-DSB','BPSK','CPFSK','GFSK','4-PAM','16-QAM','64-QAM','QPSK','WBFM'],save_filename='figure/mclstm_total_confusion.png')
    # Plot confusion matrix
    acc = {}
